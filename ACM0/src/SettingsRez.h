...
c_output c_outputs[OUTPUTS_TOTAL] = {
    ...
    {"el_53", CONTROLLINO_D3, "switch/bathroom/downstairs/main"},
    {"el_54", CONTROLLINO_D4, "light/pantry"},
    {"el_55", CONTROLLINO_D5, "light/kitchen/led"},
    {"el_56", CONTROLLINO_D6, "light/kitchen/fridge"},
    {"el_57", CONTROLLINO_D7, "switch/kitchen/island"},
    {"el_58", CONTROLLINO_D8, "switch/kitchen/dining"},
    ...
    {"el_71", CONTROLLINO_D16, "switch/living_room/one"},
    {"el_72", CONTROLLINO_D17, "switch/living_room/two"},
    {"el_73", CONTROLLINO_D18, "switch/living_room/three"},
    {"el_74", CONTROLLINO_D19, "switch/living_room/four"},
    {"el_75", CONTROLLINO_D20, "switch/living_room/five"},
